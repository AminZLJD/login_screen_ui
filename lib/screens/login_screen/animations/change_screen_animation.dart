...
class ChangeScreenAnimation {
  ...
  static final List<AnimationController> signup2Controllers = [];
  static final List<Animation<Offset>> signup2Animations = [];
  ...
  static void initialize({
    ...
    for (var i = 0; i < signup2items; i++) {
      signup2Controllers.add(
        AnimationController(
          vsync: vsync,
          duration: const Duration(milliseconds: 200),
        ),
      );
      signup2Animations.add(
        _createAnimation(
          begin: const Offset(1, 0),
          end: Offset.zero,
          parent: signup2Controllers[i],
        ),
      );
    }
  }
  ...
  static Future<void> reverse() async {
    ...
    static Future<void> nextForward() async {
    isPlaying = true;
  ...
  static Future<void> nextReverse() async {
    isPlaying = true;
